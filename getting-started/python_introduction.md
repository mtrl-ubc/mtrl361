...
Welcome to this Jupyter Notebook! In this notebook, we will explore the basics of Python programming through examples and applications tailored to modeling manufacturing processes. This resource is designed to help engineering students build foundational programming skills while connecting them to real-world contexts, such as injection molding, vacuum infusion of composites, and tensile testing.
